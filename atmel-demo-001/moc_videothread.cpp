...
static const char qt_meta_stringdata_VideoThread[] = {
    "VideoThread\0"
};
...
const QMetaObjectExtraData VideoThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VideoThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_VideoThread,
      qt_meta_data_VideoThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VideoThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoThread))
